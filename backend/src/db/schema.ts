...
export const playlistTracks = sqliteTable(
  ...
  (table) => ({
    uniquePlaylistTrack: uniqueIndex(
      "playlist_tracks_playlistId_lidarrTrackId_idx",
    ).on(table.playlistId, table.lidarrTrackId),
  }),
);
...
export const offlineTracks = sqliteTable(
  ...
  (table) => ({
    uniqueUserTrackDevice: uniqueIndex(
      "offline_tracks_userId_trackId_deviceId_idx",
    ).on(table.userId, table.lidarrTrackId, table.deviceId),
  }),
);
